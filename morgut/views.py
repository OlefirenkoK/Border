...
class SshConnect :
    ...
    def connect_ssh(self, host, port=22, name='admin', passwd='op3laf41'):
    ...
    def connect_sftp(self, host, port=22, name='admin', passwd='op3laf41'):
            ...
            if new_tt is not None :
                if form.migrate_save(new=new_tt, old=tt_id) :
                    ...
                    if mikrotik != None :
                        ...
                        try:
                            migrate_mikr.connect_ssh(host=SshConnect.make_domain(tt_id)) #host=SshConnect.make_domain(tt_id)
...
def verificate_tt(request):
    ...
    if request.POST :
        ...
        try:
            ...
            mikrotik.connect_ssh(host=SshConnect.make_domain(int(mikrotik.number))) #SshConnect.make_domain(int(mikrotik.number)) 10.11.12.57
            #SshConnect.make_domain(int(mikrotik.number)) 10.11.12.57
            ...
            mikrotik.connect_sftp(host=SshConnect.make_domain(int(mikrotik.number))) #SshConnect.make_domain(int(mikrotik.number))
